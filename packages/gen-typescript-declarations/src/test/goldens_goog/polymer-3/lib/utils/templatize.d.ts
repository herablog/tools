...
declare module 'goog:npm.polymer.polymer.lib.utils.Templatize' {
  ...
  import {MutableData} from 'goog:npm.polymer.polymer.lib.mixins.MutableData'; // from //third_party/javascript/polymer/v2/polymer

  class TemplateInstanceBase extends
    PropertyEffects(
    Object) {
   ...
   *   provided
   */
  function templatize(template: HTMLTemplateElement, owner?: PropertyEffects|null, options?: object|null): {new(): TemplateInstanceBase};
